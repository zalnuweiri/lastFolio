...
export function ProjectsPage({ theme, onBack, scrollToProjectId }: ProjectsPageProps) {
  ...
  const [loadBusinessOutcomes, setLoadBusinessOutcomes] = React.useState(false);
  const videoRefs = React.useRef<{ [key: number]: HTMLVideoElement | null }>({});
  const heroRef = React.useRef<HTMLDivElement>(null);
  const businessOutcomesRef = React.useRef<HTMLDivElement>(null);
  ...
  // Lazy load business outcomes section when it comes into view
  React.useEffect(() => {
    const businessOutcomesElement = businessOutcomesRef.current;
    if (!businessOutcomesElement) return;

    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && !loadBusinessOutcomes) {
          setLoadBusinessOutcomes(true);
        }
      },
      {
        threshold: 0.1,
    ...
    observer.observe(businessOutcomesElement);

    return () => {
      observer.disconnect();
    };
  }, [loadBusinessOutcomes]);

  const featuredProjects = [
    {
      id: 1,
      title: "Silent H Bar & Restaurant",
      subtitle: "Fullstack Web Development Contract",
      description: "Delivered a rapid Agile build converting a detailed Figma design into a pixel-accurate, responsive React site with continuous client feedback. Implemented full-stack features using React, EmailJS, and PostgreSQL, including API-based form submissions and mailing-list integration.",
      image: silentHImage,
      video: silentHImage,
      metrics: [
        { label: "PRODUCTION SITE LIVE", value: "Client-approved · Cloudflare CDN" },
        { label: "OPTIMIZED FRONTEND", value: "Reduced layout shift · CDN caching" },
        { label: "API FORMS LIVE", value: "EmailJS contact & events" }
      ],
      tags: ["React", "PostgreSQL", "EmailJS", "Cloudflare", "Figma Design"],
      year: "2025",
      client: "Silent H Bar/Restaurant",
      role: "Web Development Contractor (Fullstack)",
      link: "https://www.silenthbar.com"
    },
    {
      id: 2,
      ...
      video: metaCitiImage,
      metrics: [
        { label: "SALES-READY WEBSITE", value: "Client-facing product presentation" },
        { label: "DESIGN-ACCURATE DELIVERY", value: "Approved prototype parity" },
        { label: "SCALABLE FRONTEND BASE", value: "Modular React architecture" }
      ],
    ...
    },
    {
      ...
      subtitle: "React TypeScript Dashboard Development",
      description: "Worked on React Typescript Project, adding UI fixes, and connecting frontend additions to new backend functions. Enhanced alert workflows, timeout logic, and UI functionality for an AI-powered detection platform.",
      image: metaCitiDashboardImage,
      video: metaCitiDashboardImage,
      metrics: [
        { label: "ALERT LOGIC ENHANCED", value: "Timeouts & state handling" },
        { label: "REAL-TIME UI FIXES", value: "Production bug resolution" },
        { label: "SYSTEM USABILITY IMPROVED", value: "Operator-facing controls" }
      ],
    ...
    },
    {
      ...
      subtitle: "Brain Computer Interface Game Development",
      description: "Led development of a Python BCI game for head-mounted controllers. Delivered 80% complete pirate-themed calibration game with four out of five levels finished. Served as Scrum Master managing Jira/GitLab workflows and mentored junior developers.",
      image: pythonBCIGameImage,
      video: pythonBCIGameImage,
      metrics: [
        { label: "BCI GAME DELIVERED", value: "Calibration-focused gameplay" },
        { label: "INTERACTION MODEL VALIDATED", value: "Head-mounted controllers" },
        { label: "TEAM-LED EXECUTION", value: "Scrum workflows" }
      ],
      tags: ["Python", "Unity", "BCI", "Scrum Master", "Git", "Team Leadership"],
      year: "2025",
      client: "Zeuron",
      role: "Development Director and Team Co-Lead",
      link: "#"
    },
  ];
      ...
      <section className="bg-[#0b0615] py-20" ref={businessOutcomesRef}>
        <div className="px-8 pb-12">
          <div className="max-w-5xl mx-auto">
            ...
            <motion.p
              className="text-base text-gray-400 max-w-2xl mb-4"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              ...
              technical expertise, and collaborative execution. From full-stack web applications 
              to data-driven platforms, these works demonstrate commitment to delivering 
              exceptional user experiences and tangible value.
            </motion.p>
          </div>
        </div>
        ...
        {loadBusinessOutcomes ? (
          <div className="flex items-center justify-center px-8 pt-12">
            <div className="w-full max-w-5xl h-[128vh] md:h-screen">
              <ScrollStack
                itemDistance={200}
                  ...
                  <div className="bg-[#111111] border border-gray-800/50 rounded-3xl overflow-hidden h-full p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        {/* Metrics Grid */}
                        <ProjectMetrics metrics={featuredProjects[0].metrics} />
                      </div>
                    </div>
                  </div>
                </ScrollStackItem>
                  ...
                  <div className="bg-[#111111] border border-gray-800/50 rounded-3xl overflow-hidden h-full p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      >
                        ...
                        {featuredProjects[1].video && (
                          <motion.div
                            className="absolute inset-0"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: hoveredProject === featuredProjects[1].id ? 1 : 0 }}
                            transition={{ duration: 0.5 }}
                          >
                            <video
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <ProjectMetrics metrics={featuredProjects[1].metrics} />
                      </div>
                    </div>
                  </div>
                </ScrollStackItem>
                  ...
                  <div className="bg-[#111111] border border-gray-800/50 rounded-3xl overflow-hidden h-full p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <ProjectMetrics metrics={featuredProjects[2].metrics} />
                      </div>
                    </div>
                  </div>
                </ScrollStackItem>
                  ...
                  <div className="bg-[#111111] border border-gray-800/50 rounded-3xl overflow-hidden h-full p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col justify-between">
                        ...
                        <ProjectMetrics metrics={featuredProjects[3].metrics} />
                      </div>
                    </div>
                  </div>
                </ScrollStackItem>
