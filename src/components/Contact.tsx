...
export function Contact({ theme }: ContactProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const serviceId = 'service_a8kzzpf';
    const templateId = 'template_7iksatp';
    const publicKey = 'P9Ssk3KX4AXuSwXc3';
  ...
  const socialLinks = [
    { icon: Github, label: 'GitHub', href: 'https://github.com/zalnuweiri' },
    { icon: Linkedin, label: 'LinkedIn', href: 'https://www.linkedin.com/in/zayd-alnuweiri/' },
    { icon: Mail, label: 'Email', href: 'mailto:zhmalnuweiri@gmail.com' },
  ];
