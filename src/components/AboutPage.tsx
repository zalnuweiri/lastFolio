...
import { User, Code, Heart, Zap, Award, Coffee, Briefcase, Calendar, MapPin, GraduationCap, Layers, Database, Terminal, Palette, Download, Mail, Linkedin, Github, ExternalLink, TrendingUp, Target, BookOpen, ChevronDown, ChevronUp, Search } from 'lucide-react';
