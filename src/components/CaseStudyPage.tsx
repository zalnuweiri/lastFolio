...
export function CaseStudyPage({ theme, onBack }: CaseStudyPageProps) {
  ...
  const featuredProjects: FeaturedProject[] = [
    {
      ...
      image: silentHImage,
      metrics: [
        { label: "Dev Time", value: "4 months" },
        { label: "Stack", value: "React + PostgreSQL" },
        { label: "Migration", value: "Netlify → Cloudflare" },
        { label: "Features", value: "Forms + Newsletter" }
      ],
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "Design", value: "Figma → React" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "Testing", value: "Linux-based" },
        { label: "Documentation", value: "Git Repos" },
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "Levels", value: "4/5 Complete" },
        { label: "Platform", value: "Python + Unity" },
        { label: "Role", value: "Team Co-Lead" }
      ],
  ...
  return (
    <div className="min-h-screen bg-[#0b0615]">
      ...
      <div className="flex items-center justify-center px-8 pt-12 pb-[200vh]">
        <div className="w-full max-w-5xl h-[125vh]">
          <ScrollStack
            itemDistance={400}
          ...
          >
            ...
            <ScrollStackItem itemClassName="custom-project-card">
              <div className="bg-[#111111] border border-gray-800/50 rounded-3xl overflow-hidden min-h-[75vh] max-h-[75vh] md:h-full p-6 md:p-8 overflow-y-auto">
                {/* Project Header */}
