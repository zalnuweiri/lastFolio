  ...
  const faces = [
    {
      ...
      items: ['5+ Years', 'Full-Stack Dev', '26+ Projects', 'Multiple Industries'],
    },
    {
      title: 'SKILLS',
      icon: Code2,
      ...
      items: ['React JSX/TSX', 'UI/UX Design', 'API Integration', 'SQL & Database Design'],
    },
    {
      title: 'SHIPPED WORK',
      icon: Award,
      ...
      items: ['Live restaurant systems', 'User Software Dashboards', 'Production systems', 'Legacy systems repaired'],
    },
    {
      title: 'AVAILABILITY',
      icon: Calendar,
